...
#'
#' @details `GSEAweight1Score()` returns a data.frame, each row of which contains score,
...
#######################The implementation of GSEAweight1########################
GSEAweight1Score <- function(refMatrix, queryUp, queryDown, permuteNum = 10000,
  ...
  score <- mclapply(refList, weight1, queryUp = queryUp,
